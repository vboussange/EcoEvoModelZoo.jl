...
sourceCpp("/Users/victorboussange/ETHZ/projects/EcoEvoModelZoo.jl/test/Akesson_et_al/rhs_eval.cpp") # compile external C functions
...
if (length(clargs)>0) { # command-line arguments
  ...
  model <- "normal" # 2 trophic levels & temperature-dependent competition
